...
-----------------------------------------------------------------------------------------------------------
controller.m, trajectory_generator.m: You have alredy done in phase1 and phase2. Copy them into this directory (/code) to run the pipeline.
If you still have problems with your controller, please contact TAs.
...
Contact TAs for any questions you may have.